...
function edit(){
  ...
  if (rsName == sheetName) {
    ...
    if ((row > myNumbers.expenseCarryOverRow) && (row <= myNumbers.expenseLastRow)) {
      ...
      formulaSp1 += amountRange.getA1Notation() + '*' + rsName + '!$' + splitDashRange1.getA1Notation().substr(0,1);
      ...
      formulaSp2 += amountRange.getA1Notation() + '*' + rsName + '!$' + splitDashRange2.getA1Notation().substr(0,1);
      ...
      if (row < myNumbers.expenseLastRow) validateType(row+1, col);
